...
* Put Glyphs, Sprites, style file and mbtiles into the [OruxMaps](https://www.oruxmaps.com/cs/en/) mapfiles directory and refresh data sources
...
More information can be found in my [blog post series](https://projects.webvoss.de/2024/08/03/next-generation-perfect-offline-hiking-maps-superatlas-goes-vector-part-i-introduction/).
...
* Fonts:
  ...
  * Roboto fonts are under [SIL Open Font license 1.1](https://fonts.google.com/specimen/Roboto/license) - full information on Open Font license can be found [here](https://openfontlicense.org/).
